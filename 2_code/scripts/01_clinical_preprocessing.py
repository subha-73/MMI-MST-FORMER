...
def load_grape_data():
    ...
    # =================================================================
    # Progression Flag Logic (Kept for completeness, not used for regression target)
    # =================================================================
    ...
    if found_labels:
        ...
        print(f"  Progression Indicators used for static label: {found_labels}")
    else:
        # Warning, but do not fail, as the primary task is regression on VF points
        print("  WARNING: No Progression labels found. Progression_Flag set to 0.")
        base_df['Progression_Flag'] = 0
    # =================================================================
...
def split_patients(df):
    ...
    # Split 70% Train, 30% Temp (Temp will be split into Val/Test)
